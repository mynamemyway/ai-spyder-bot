...
START_MESSAGE_TEXT = (
    "Добрый день!\n\n"
    "Я — AI-консультант. Готов ответить на ваши вопросы.\n\n"
    "Просто задайте мне вопрос или нажмите кнопку помощи."
)
...
RESET_CONFIRMATION_TEXT = "🧹 История диалога успешно очищена."
